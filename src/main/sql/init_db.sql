...
CREATE SEQUENCE public.supplier_id_seq
  ...
  NO CYCLE;
ALTER TABLE public.supplier
  ALTER COLUMN id SET DEFAULT nextval('public.supplier_id_seq');
...
CREATE SEQUENCE public.orderlist_id_seq
  NO MINVALUE
  NO MAXVALUE
  NO CYCLE;
ALTER TABLE public.orderlist
  ALTER COLUMN id SET DEFAULT nextval('public.orderlist_id_seq');
ALTER SEQUENCE public.orderlist_id_seq
OWNED BY public.orderlist.id;
...
ALTER TABLE public.productcategory
  ALTER COLUMN id SET DEFAULT nextval('public.productcategory_id_seq');
ALTER SEQUENCE public.productcategory_id_seq
OWNED BY public.productcategory.id;
